...
def incluir_aluno(self):
    ...
    aluno = Aluno(dados_aluno["Nome"], dados_aluno["Telefone"], dados_aluno['Email'], dados_aluno['Data de nascimento'],
...
def incluir_professor(self):
    ...
    professor = Professor(dados_professor["Nome"], dados_professor["Telefone"], dados_professor['Email'], dados_professor['Data de nascimento'],
...
def lista_professores(self):
    for professor in self.__professor:
        self.__telaUsuario.mostra_professor({"Nome": professor.nome, "Telefone": professor.telefone, 'Email': professor.email,
